...
// TEST
	boolean (*allSatisfy)(struct ArrayedCollection* self, boolean (*Condition)(struct ArrayedCollection* self, void* item, void* aParameter), void* aParameter);
	boolean (*anySatisfy)(struct ArrayedCollection* self, boolean (*Condition)(void*self, void* item, void* aParameter), void* aParameter);
// ITERATION
	struct Collection* (*collect)(struct ArrayedCollection* self, void* (*Map)(void* item));
	void* (*detect)(struct ArrayedCollection* self, boolean (*Comparator)(struct ArrayedCollection* self, void* item, void*aParameter), void* aParameter);
...
#define TYPED_ARRAYED_COLLECTION(Name,X) typedef struct Name {\
	...
	boolean(*allSatisfy) (struct Name * self, boolean(*Condition) (struct Name * self, X item, void* aParameter), void* aParameter);\
	boolean(*anySatisfy) (struct Name * self, boolean(*Condition) (void*self, X item, void* aParameter), void* aParameter);\
	Collection* (*collect) (struct Name * self, void* (*Map) (X item));\
	X (*detect) (struct Name * self, boolean(*Comparator) (struct Name * self, X item, void*aParameter), void* aParameter);\
...
#define TYPED_ARRAYED_COLLECTION_INITIALIZE(Name,X) void Initialize_## Name ##_Object (struct Name * Instance){\
	...
	Instance->allSatisfy = (boolean(*) (struct Name * self, boolean(*Condition) (struct Name * self, X item, void* aParameter), void* aParameter)) Arrayed_Collection_AllSatisfy;\
	Instance->anySatisfy = (boolean(*) (struct Name * self, boolean(*Condition) (void*self, X item, void* aParameter), void* aParameter)) Arrayed_Collection_AnySatisfy;\
	Instance->collect = (Collection* (*) (struct Name * self, void* (*Map) (X item))) Arrayed_Collection_Collect;\
	Instance->detect = (X (*) (struct Name * self, boolean(*Comparator) (struct Name * self, X item, void*aParameter), void* aParameter)) Arrayed_Collection_Detect;\
